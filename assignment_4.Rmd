...
title: | 
  ...
  | 2022-2023
author: |
  | Olivier van der Meulen
  | o.b.p.vandermeulen@students.uu.nl
  | http://www.github.com/ovdm01
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
After running the summary data, you see that there is a difference in the summary statistics for countries with 0 revolutions and countries with more than 0 revolutions. the mean and median differ for example. the means for countries revolutions are namely lower (esp. for rgdp6). we can conclude that country with more than 0 revolutions have lower growth rates.
...
group1 <- GrowthSW$growth[GrowthSW$treat == "No Revolutions"]
group2 <- GrowthSW$growth[GrowthSW$treat == "More than 0 Revolutions"]
...
we include this variable to use this a baseline to compare against the new gdp's. we need to do this to filter the inflation out of our research as we don't want this to be included in our results
...
i think education as this increases the r^2 number up the most when it is introduced to the model
